        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("ACCOUNT_CLAIM_SUBMITTED", "Account claim submitted"),
                    ("ACCOUNT_CLAIM_APPROVED", "Account claim approved"),
                    ("ACCOUNT_CLAIM_REJECTED", "Account claim rejected"),
                    ...
                    ("REGISTRATION_SESSION_CREATED", "Registration session created"),
                    ("REGISTRATION_EMAIL_VERIFIED", "Registration email verified"),
                    (
                    ...
                    ("IDENTITY_DOCUMENT_REJECTED", "Identity document rejected"),
                    ("IDENTITY_DOCUMENT_REPLACED", "Identity document replaced"),
                    (
                    ...
                    ("GUARDIAN_RELATIONSHIP_ENDED", "Guardian relationship ended"),
                    (
                        "GUARDIAN_RELATIONSHIP_DISMISSED",
                        "Guardian relationship dismissed",
                    ),
                    ("GUARDIAN_ACCESS_EXPIRED", "Guardian access expired"),
                    ...
                    ("ACCOUNT_ACTIVATION_CREATED", "Account activation created"),
                    ("DOCUMENT_UPLOADED", "Document uploaded"),
                    ("DOCUMENT_METADATA_UPDATED", "Document metadata updated"),
                    ("DOCUMENT_DELETED", "Document deleted"),
                    ("DOCUMENT_TYPE_CHANGED", "Document type changed"),
                    ("DOCUMENT_FACILITY_CHANGED", "Document facility changed"),
                    ("FILE_INTEGRITY_CHECKED", "File integrity checked"),
